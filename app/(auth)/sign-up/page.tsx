      ...
      <div className="relative w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full rounded-2xl bg-[#1c1c1c] border border-[#2a2a2a] shadow-2xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl bg-white py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-3"
          >
            {googleLoading ? (
          ...
          <button
            ...
            disabled={googleLoading || githubLoading || loading}
            className="w-full flex items-center justify-center gap-3 rounded-xl bg-[#24292e] py-3 text-sm font-medium text-white hover:bg-[#2f363d] transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-4"
          >
            {githubLoading ? (
