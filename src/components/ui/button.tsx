...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          'bg-yellow-300 text-slate-800 font-bold rounded-xl border-b-4 border-b-yellow-400 hover:bg-yellow-400 hover:border-b-yellow-500 hover:text-slate-900 transition-all duration-300 hover:-translate-y-0.5 hover:cursor-pointer text-lg shadow-md',
        destructive:
        ...
        secondary:
          'bg-white text-slate-800 font-bold rounded-xl border-b-4 border-b-slate-400 hover:bg-gray-200 hover:border-b-slate-500 hover:text-slate-900 transition-all duration-300 hover:-translate-y-0.5 hover:cursor-pointer text-lg shadow-md',
        ghost:
