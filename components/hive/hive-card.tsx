...
export default function HiveCard({ hive }: { hive: HiveWithMembership }) {
  ...
  return (
    <Link
      href={`/hive/${hive.id}`}
      className="group flex flex-col rounded-2xl bg-[#1c1c1c] border border-[#2a2a2a] overflow-hidden hover:border-[#FFC300]/30 hover:bg-[#222222] transition-all duration-200"
    >
