...
function Avatar({
  ...
  return (
    <div className={`rounded-full bg-white/10 flex items-center justify-center shrink-0 font-bold text-white/70 ${className}`}>
      {fallback}
    </div>
  );
}
    ...
    <div className="flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs text-white/70">{timeAgo(reply.createdAt)}</span>
        </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-white/70">{timeAgo(comment.createdAt)}</span>
          </div>
