...
export default function ClubCard({ club }: { club: ClubWithMembership }) {
  ...
  return (
    <Link
      href={`/clubs/${club.id}`}
      className="group flex flex-col rounded-2xl bg-[#1c1c1c] border border-[#2a2a2a] overflow-hidden hover:border-[#fb923c]/30 hover:bg-[#222222] transition-all duration-200"
    >
