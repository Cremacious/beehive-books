...
import { getClubAction, getClubFriendsForInviteAction } from '@/lib/actions/club.actions';
...
export default async function ClubSettingsPage({
  ...
  const invitableFriends = (await getClubFriendsForInviteAction(clubId)) as FriendUser[];
  ...
  return (
    <div className="px-4 py-6 md:px-8 max-w-2xl mx-auto">
      ...
      <div className="bg-[#1e1e1e] rounded-2xl border border-[#2a2a2a] p-6">
        <EditClubForm club={club} invitableFriends={invitableFriends} />
      </div>
    </div>
  );
}
