import type { Book, Chapter, Collection, Comment, ChapterNav } from '@/lib/types/books';
...
export const SAMPLE_BOOKS: Book[] = [
  ...
  },
  {
    ...
    category:     'Fiction',
    description:  'An epic journey across dying star systems as the last cartographers of the universe race to map what remains before the lights go out forever.',
    privacy:      'PUBLIC',
    wordCount:    31500,
    commentCount: 14,
    chapterCount: 7,
  ...
  },
  {
    ...
    genre:        'Romance',
    category:     'Fiction',
    description:  'Twenty-four letters written over twenty years — none of them ever mailed. A quiet love story told entirely through what was never said.',
    privacy:      'FRIENDS',
    wordCount:    68400,
    commentCount: 57,
    chapterCount: 24,
  ...
  },
  {
    ...
    genre:        'Fantasy',
    category:     'Fiction',
    description:  'A merchant following an ancient trade route discovers that the amber she carries contains something alive — and very old.',
    privacy:      'PRIVATE',
    wordCount:    9200,
    commentCount: 0,
    chapterCount: 3,
  ...
  },
  {
    ...
    genre:        'Thriller',
    category:     'Fiction',
    description:  'A late-night radio host receives a call from someone who claims to have witnessed a murder — eighteen years ago, in the host\'s own home.',
    privacy:      'PUBLIC',
    wordCount:    52700,
    commentCount: 41,
    chapterCount: 18,
  ...
  },
  {
    ...
    description:  'A memoir-in-essays exploring what it means to choose quiet in a world that rewards noise.',
    privacy:      'PUBLIC',
    wordCount:    28900,
    commentCount: 22,
    chapterCount: 9,
...
export const SAMPLE_CHAPTERS: Chapter[] = [
  {
    id: 'ch1', bookId: '1', title: 'The Return',      wordCount: 3420, order: 1, collectionId: null,
    authorNotes: null,
    content:     null,
  },
  {
    id: 'ch2', bookId: '1', title: 'First Light',     wordCount: 2890, order: 2, collectionId: null,
    authorNotes: null,
    content:     null,
  },
  {
  ...
  {
    id: 'ch4', bookId: '1', title: 'The Photograph',  wordCount: 3600, order: 4, collectionId: 'col1',
    authorNotes: null,
    content:     null,
  },
  {
    id: 'ch5', bookId: '1', title: 'A Name Unspoken', wordCount: 5200, order: 5, collectionId: 'col1',
    authorNotes: null,
    content:     null,
  },
  {
    id: 'ch6', bookId: '1', title: 'Roots',           wordCount: 2750, order: 6, collectionId: null,
    authorNotes: null,
    content:     null,
  },
];
...
export const SAMPLE_COMMENTS: Comment[] = [
  {
    id:        'c1',
    chapterId: 'ch3',
    user:      { name: 'Riley Thompson', initials: 'RT', colorClass: 'bg-purple-500/20 text-purple-300' },
    ...
    replies: [
      {
        id:        'r1',
        user:      { name: 'Jordan Lee', initials: 'JL', colorClass: 'bg-blue-500/20 text-blue-300' },
  ...
  },
  {
    id:        'c2',
    chapterId: 'ch3',
    user:      { name: 'Avery Chen', initials: 'AC', colorClass: 'bg-emerald-500/20 text-emerald-300' },
...
/* ─── Query helpers ───────────────────────────────────────────────────────────
   Synchronous functions that mirror what Drizzle DB queries will look like.
   Replace each with the real query when wiring up Neon.
────────────────────────────────────────────────────────────────────────────── */
