...
export const metadata: Metadata = {
  title: 'Explore',
  description:
    'Discover books, authors, and reading groups from across the Beehive Books community.',
};
  ...
  return (
    <section className="mb-10">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base font-bold text-white mainFont">
          Friends are Reading
        </h2>
      </div>
...
export default async function ExplorePage() {
  const [
    { clubs, hives, prompts, readingLists },
    { featured, popular, trending, genreRows },
    friendsBooks,
  ] = await Promise.all([
    getExplorableHubDataAction(),
    getExplorableBooksByGenreAction(),
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative px-4 md:px-8 pb-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <p className="text-white/80 text-base max-w-lg mb-6">
            Books, writing communities, and creative challenges from the Beehive
            Books community.
          </p>
      ...
      {/* Content */}
      <div className="px-0 md:px-8 pb-12 max-w-6xl mx-auto">
        {friendsBooks.length > 0 && (
          <FriendsReadingSection books={friendsBooks} />
        )}
        <ExploreHub
          featured={featured}
          popular={popular}
