    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4 dark:bg-zinc-950">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-sm dark:bg-zinc-900">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-500">Choose a username to get started</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center rounded-lg border border-zinc-200 bg-white px-3 focus-within:ring-2 focus-within:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:focus-within:ring-zinc-100">
            ...
            <p className="text-xs text-zinc-400">Letters, numbers, and underscores only.</p>
          </div>
